...
public static class StudentManagementSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StudentManagementSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
