...
public class StudentManagementSystemDbContext :
    AbpDbContext<StudentManagementSystemDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(StudentManagementSystemConsts.DbTablePrefix + "YourEntities", StudentManagementSystemConsts.DbSchema);
